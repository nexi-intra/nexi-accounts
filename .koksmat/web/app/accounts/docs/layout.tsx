...
const navItems = [
  { href: '/accounts/docs', label: 'Documentation' },
  { href: '/accounts/docs/use-cases', label: 'Use Cases' },
  { href: '/accounts/docs/components', label: 'Components' },
  { href: '/accounts/docs/api', label: 'API' },
