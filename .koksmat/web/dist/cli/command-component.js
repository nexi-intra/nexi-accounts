...
function setupComponentCommand(program) {
    ...
    component
        ...
        const componentManager = new component_manager_1.ComponentManager(appPath);
        try {
...
exports.setupComponentCommand = setupComponentCommand;
